export const CONNECTORS = [
  ...
  },
  {
    ...
    piggybakcsOn: 'entra',
    permissions: ['Detect email forwarding to external addresses', 'Find SharePoint sites with external sharing', 'Flag stale guest accounts', 'Map findings to NCA ECC 2-7-2, 2-4-2, 2-2-3-3, 2-2-3-5 and SDAIA PDPL'],
  },
  {
    id: 'defender',
    ...
    permissions: [
      ...
      'Read Defender XDR alerts (endpoint, identity, email, cloud apps)',
      'Read Defender for Endpoint vulnerabilities and device health',
      'Map findings to NCA ECC 2-2, 2-3, 2-4, 2-7, 2-10 and 2-13',
    ],
  },
  {
    id: 'sharepoint',
    ...
    piggybakcsOn: 'entra',
    permissions: [
      'Read tenant sharing settings (SharePointTenantSettings.Read.All)',
      'Read sites, libraries and sharing permissions (Sites.Read.All)',
      'Read Microsoft 365 group members to find guests (Directory.Read.All)',
      'Map findings to NCA ECC 2-7-2, 2-2-2, 2-2-3, 2-6-3 and SDAIA PDPL-IR Arts. 20 and 23',
    ],
  },
  {
    id: 'jira',
